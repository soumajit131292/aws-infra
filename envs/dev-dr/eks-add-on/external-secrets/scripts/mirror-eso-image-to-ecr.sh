...
#
# Optional overrides:
#   AWS_REGION=us-west-1 ACCOUNT_ID=123456789012 ECR_PREFIX=thirdparty SUFFIX=amd64-platform ./mirror-eso-image-to-ecr.sh
...
echo "=================================================="
echo "External Secrets image pushed successfully"
echo "Use this tag in Helm values: ${NEW_TAG}"
